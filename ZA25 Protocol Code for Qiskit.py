...
counts_df.index.name = 'measurement'
counts_df.to_csv('measurement_results.csv')
print("Measurement results saved to measurement_results.csv")

# Plot and save the histogram
plot_histogram(counts)
plt.savefig('measurement_histogram.png')
print("Measurement histogram saved to measurement_histogram.png")
plt.show()
